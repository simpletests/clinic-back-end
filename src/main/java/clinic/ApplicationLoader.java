...
public class ApplicationLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent e) {
        ...
        User medico1 = new User("Dr. Carlos da Silva Santos", "carlos", "123", true, Role.MEDICO);
        User medico2 = new User("Dra. Silvia Maria da Silva", "silvia", "123", true, Role.MEDICO);
